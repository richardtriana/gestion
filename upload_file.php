...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (move_uploaded_file($_FILES['file']['tmp_name'], $target_file)) {
        $_SESSION['upload_success'] = '¡Archivo subido con éxito!';
    } else {
...
<body>
    ...
    <div class="info-container">
        <span>Sube tu archivo al directorio: <?php echo htmlspecialchars($current_dir); ?></span>
    </div>
    <main>
        <div class="content-panel">
            <form id="uploadForm" action="upload_file.php?dir=<?php echo urlencode($current_dir); ?>" method="post" enctype="multipart/form-data" class="upload-form">
